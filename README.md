...
Rådhuset API Browser är fri programvara som licensieras under **GNU General Public License, version 3 eller senare**. Se [LICENSE](LICENSE) för den fullständiga texten.
...
Rådhuset API Browser is free software, licensed under the **GNU General Public License, version 3 or later**. See [LICENSE](LICENSE) for the full text.
